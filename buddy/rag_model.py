...
def create_or_load_vector_embedding_for_excel():
    ...
    if os.path.exists(persist_directory):
        ...
        documents = load_excel_documents("excel_files/output.xlsx")  # <-- Your Excel file path
...
if __name__ == "__main__":
    ...
    vectors = create_or_load_vector_embedding_for_excel()
